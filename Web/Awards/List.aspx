<%@ Page Title="Awards" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Eva.Web.Awards.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="IsCheck" HeaderText="IsCheck" SortExpression="IsCheck" ItemStyle-HorizontalAlign="Center"  /> 
