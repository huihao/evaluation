...
namespace Eva.DAL
{
	...
	public partial class Teach
	{
		...
		public Eva.Model.Teach GetModel(int Id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 Id,CourseId,TeacherId,AcademicYear,SchoolTerm from Teach ");
			strSql.Append(" where Id=@Id");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)
			};
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select Id,CourseId,TeacherId,AcademicYear,SchoolTerm ");
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" Id,CourseId,TeacherId,AcademicYear,SchoolTerm ");
			strSql.Append(" FROM Teach ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
