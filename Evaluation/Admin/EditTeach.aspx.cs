...
{
    public partial class EditTeach : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                teach = bll.GetModel(id);

                LoadTeacher();
                LoadCourse();

                TeacherList.Items.FindByValue(teach.TeacherId.ToString()).Selected = true;
                CourseList.Items.FindByValue(teach.CourseId.ToString()).Selected = true;
            }
        }
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (bll.Update(teach))
            {
                Maticsoft.Common.MessageBox.ShowAndRedirect(this, "修改成功！", "TeachList.aspx");
            }
            else
            {
